...
@Configurablepublic abstract class GeneralAddress implements Serializable {
	...
	public static GeneralAddress fromJsonToGeneralAddress(String json) {
        return new JSONDeserializer<GeneralAddress>()
        .use(null, GeneralAddress.class).deserialize(json);
    }

//	public static String toJsonArray(Collection<GeneralAddress> collection) {
//        return new JSONSerializer()
//        .exclude("*.class").serialize(collection);
//    }
//
//	public static String toJsonArray(Collection<GeneralAddress> collection, String[] fields) {
//        return new JSONSerializer()
//        .include(fields).exclude("*.class").serialize(collection);
//    }

	public static Collection<GeneralAddress> fromJsonArrayToGeneralAddresses(String json) {
