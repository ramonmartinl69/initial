...
privileged aspect Person_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Person.fieldNames4OrderClauseFilter = java.util.Arrays.asList("firstName", "lastName", "lastName2", "birthDate", "nationality", "nIF", "photoFile", "phone", "question", "response", "alternateQuestion", "alternateResponse", "principal", "addresses");
