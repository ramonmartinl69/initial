...
privileged aspect Principal_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Principal.fieldNames4OrderClauseFilter = java.util.Arrays.asList("userName", "password", "repeatPassword", "enabled", "activationKey", "roles", "person");
