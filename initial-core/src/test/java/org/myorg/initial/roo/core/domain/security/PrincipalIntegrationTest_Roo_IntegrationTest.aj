...
privileged aspect PrincipalIntegrationTest_Roo_IntegrationTest {
    ...
    @Autowired
    PrincipalService PrincipalIntegrationTest.principalService;
    
    @Autowired
    PrincipalRepository PrincipalIntegrationTest.principalRepository;
    
    @Test
    public void PrincipalIntegrationTest.testCountAllPrincipals() {
    ...
    @Test
    public void PrincipalIntegrationTest.testUpdatePrincipalUpdate() {
        Principal obj = dod.getRandomPrincipal();
        Assert.assertNotNull("Data on demand for 'Principal' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Principal' failed to provide an identifier", id);
    ...
    @Test
    public void PrincipalIntegrationTest.testSavePrincipal() {
        Assert.assertNotNull("Data on demand for 'Principal' failed to initialize correctly", dod.getRandomPrincipal());
    ...
    @Test
    public void PrincipalIntegrationTest.testDeletePrincipal() {
        Principal obj = dod.getRandomPrincipal();
        Assert.assertNotNull("Data on demand for 'Principal' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Principal' failed to provide an identifier", id);
