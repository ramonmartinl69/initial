...
import org.myorg.initial.roo.core.domain.model.OtherAddressIntegrationTest;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.test.context.ContextConfiguration;
import org.springframework.test.context.junit4.SpringJUnit4ClassRunner;
import org.springframework.transaction.annotation.Transactional;

privileged aspect OtherAddressIntegrationTest_Roo_IntegrationTest {
    
    declare @type: OtherAddressIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: OtherAddressIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: OtherAddressIntegrationTest: @Transactional;
    
    @Autowired
    OtherAddressDataOnDemand OtherAddressIntegrationTest.dod;
    
    @Test
    public void OtherAddressIntegrationTest.testCountOtherAddresses() {
    ...
    @Test
    public void OtherAddressIntegrationTest.testFindOtherAddress() {
    ...
    @Test
    public void OtherAddressIntegrationTest.testFindAllOtherAddresses() {
        Assert.assertNotNull("Data on demand for 'OtherAddress' failed to initialize correctly", dod.getRandomOtherAddress());
        long count = OtherAddress.countOtherAddresses();
    ...
    @Test
    public void OtherAddressIntegrationTest.testFindOtherAddressEntries() {
        Assert.assertNotNull("Data on demand for 'OtherAddress' failed to initialize correctly", dod.getRandomOtherAddress());
        long count = OtherAddress.countOtherAddresses();
    ...
    @Test
    public void OtherAddressIntegrationTest.testFlush() {
        OtherAddress obj = dod.getRandomOtherAddress();
        Assert.assertNotNull("Data on demand for 'OtherAddress' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'OtherAddress' failed to provide an identifier", id);
    ...
    @Test
    public void OtherAddressIntegrationTest.testMergeUpdate() {
        OtherAddress obj = dod.getRandomOtherAddress();
        Assert.assertNotNull("Data on demand for 'OtherAddress' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'OtherAddress' failed to provide an identifier", id);
    ...
    @Test
    public void OtherAddressIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'OtherAddress' failed to initialize correctly", dod.getRandomOtherAddress());
    ...
    @Test
    public void OtherAddressIntegrationTest.testRemove() {
        OtherAddress obj = dod.getRandomOtherAddress();
        Assert.assertNotNull("Data on demand for 'OtherAddress' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'OtherAddress' failed to provide an identifier", id);
