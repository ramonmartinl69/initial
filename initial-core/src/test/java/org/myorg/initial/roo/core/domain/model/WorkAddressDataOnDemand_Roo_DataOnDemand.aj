...
privileged aspect WorkAddressDataOnDemand_Roo_DataOnDemand {
    ...
    declare @type: WorkAddressDataOnDemand: @Component;
    ...
    public void WorkAddressDataOnDemand.setAddresNumber(WorkAddress obj, int index) {
    ...
    public void WorkAddressDataOnDemand.setAddress(WorkAddress obj, int index) {
    ...
    public void WorkAddressDataOnDemand.setAddressType(WorkAddress obj, int index) {
        AddressTypeEnum addressType = AddressTypeEnum.class.getEnumConstants()[0];
        obj.setAddressType(addressType);
    }
    
    public void WorkAddressDataOnDemand.setCountry(WorkAddress obj, int index) {
        CountryEnum country = CountryEnum.class.getEnumConstants()[0];
        obj.setCountry(country);
    }
    
    public void WorkAddressDataOnDemand.setEnterpriseName(WorkAddress obj, int index) {
    ...
    public void WorkAddressDataOnDemand.setPostalAddress(WorkAddress obj, int index) {
    ...
    public WorkAddress WorkAddressDataOnDemand.getSpecificWorkAddress(int index) {
        init();
        if (index < 0) {
            index = 0;
        }
    ...
    public WorkAddress WorkAddressDataOnDemand.getRandomWorkAddress() {
        init();
    ...
    public boolean WorkAddressDataOnDemand.modifyWorkAddress(WorkAddress obj) {
        return false;
    }
    
    public void WorkAddressDataOnDemand.init() {
        int from = 0;
        int to = 10;
