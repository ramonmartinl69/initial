...
public class OtherAddressDataOnDemand {
	...
	private List<OtherAddress> data;

	@Autowired
    PersonDataOnDemand personDataOnDemand;

	public OtherAddress getNewTransientOtherAddress(int index) {
	...
	public void setActive(OtherAddress obj, int index) {
        Boolean active = Boolean.TRUE;
        obj.setActive(active);
    }

	public void setAddresNumber(OtherAddress obj, int index) {
	...
	public void setAddress(OtherAddress obj, int index) {
	...
	public void setProvince(OtherAddress obj, int index) {
        ProvinceEnum province = ProvinceEnum.class.getEnumConstants()[0];
        obj.setProvince(province);
    }

	public OtherAddress getSpecificOtherAddress(int index) {
        init();
        if (index < 0) {
            index = 0;
        }
	...
	public OtherAddress getRandomOtherAddress() {
        init();
	...
	public boolean modifyOtherAddress(OtherAddress obj) {
        return false;
    }
