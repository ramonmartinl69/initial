...
privileged aspect WorkAddressIntegrationTest_Roo_IntegrationTest {
    
    declare @type: WorkAddressIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: WorkAddressIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: WorkAddressIntegrationTest: @Transactional;
    
    @Autowired
    WorkAddressDataOnDemand WorkAddressIntegrationTest.dod;
    
    @Test
    public void WorkAddressIntegrationTest.testCountWorkAddresses() {
    ...
    @Test
    public void WorkAddressIntegrationTest.testFindWorkAddress() {
    ...
    @Test
    public void WorkAddressIntegrationTest.testFindAllWorkAddresses() {
        Assert.assertNotNull("Data on demand for 'WorkAddress' failed to initialize correctly", dod.getRandomWorkAddress());
        long count = WorkAddress.countWorkAddresses();
    ...
    @Test
    public void WorkAddressIntegrationTest.testFindWorkAddressEntries() {
        Assert.assertNotNull("Data on demand for 'WorkAddress' failed to initialize correctly", dod.getRandomWorkAddress());
        long count = WorkAddress.countWorkAddresses();
    ...
    @Test
    public void WorkAddressIntegrationTest.testFlush() {
        WorkAddress obj = dod.getRandomWorkAddress();
        Assert.assertNotNull("Data on demand for 'WorkAddress' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'WorkAddress' failed to provide an identifier", id);
    ...
    @Test
    public void WorkAddressIntegrationTest.testMergeUpdate() {
        WorkAddress obj = dod.getRandomWorkAddress();
        Assert.assertNotNull("Data on demand for 'WorkAddress' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'WorkAddress' failed to provide an identifier", id);
    ...
    @Test
    public void WorkAddressIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'WorkAddress' failed to initialize correctly", dod.getRandomWorkAddress());
    ...
    @Test
    public void WorkAddressIntegrationTest.testRemove() {
        WorkAddress obj = dod.getRandomWorkAddress();
        Assert.assertNotNull("Data on demand for 'WorkAddress' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'WorkAddress' failed to provide an identifier", id);
