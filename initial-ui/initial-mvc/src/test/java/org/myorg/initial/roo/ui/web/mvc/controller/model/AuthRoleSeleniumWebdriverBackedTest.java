 ...
 *
 */
public class AuthRoleSeleniumWebdriverBackedTest {
	...
	@Test
	public void testAuthRoleSeleniumWebdriverBacked() throws Exception {
		...
		selenium.click("link=Create new Auth Role");
		selenium.waitForPageToLoad("30000");
		selenium.type("id=_roleName_id", "roleName");
		selenium.click("id=proceed");
		selenium.waitForPageToLoad("30000");
		assertEquals("roleName", selenium.getText("_s_org_myorg_initial_roo_core_domain_security_AuthRole_roleName_roleName_id"));
	}
