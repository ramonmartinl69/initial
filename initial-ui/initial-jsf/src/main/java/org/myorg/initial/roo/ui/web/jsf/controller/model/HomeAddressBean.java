...
@Configurable
@ManagedBean(name = "homeAddressBean")
@SessionScoped
@RooSerializable
...
public class HomeAddressBean implements Serializable {
	...
	private String name = "HomeAddresses";

	private HomeAddress homeAddress;

	private List<HomeAddress> allHomeAddresses;
	...
	public List<HomeAddress> getAllHomeAddresses() {
        return allHomeAddresses;
    }

	public void setAllHomeAddresses(List<HomeAddress> allHomeAddresses) {
        this.allHomeAddresses = allHomeAddresses;
    }

	public String findAllHomeAddresses() {
